# -*- coding: utf-8 -*-
"""
Created on Fri Oct 13 17:55:00 2023
...
# Display the modified input matrix
display_matrix(input_matrix, 'Modified Input Matrix')

# Display the result of FMCC implementation
display_matrix(fmcc_result, 'MFCC Implementation')